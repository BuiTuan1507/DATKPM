              ...
              child: Column(
                children: <Widget>[
                  ...
                  ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount: widget.needPay.length,
                            ...
                            child: Row(
                              children: <Widget>[
                                ...
                                Container(
                                  ...
                                  child: Text(
                                    widget.needPay[index].item.image.length
                                        .toString(),
                                    style: TextStyle(
                                        fontSize: 18,
                                  ...
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      Container(
                                        ...
                                        child: Text(
                                          widget.needPay[index].item.name,
                                          style: TextStyle(
                                              fontSize: 18,
                                      ...
                                      Container(
                                        padding: EdgeInsets.only(
                                            left: 15, bottom: 10),
                                        child: Text(
                                          widget.needPay[index].item.cost
                                              .toString() +
                                              ' đ',
                                          style: TextStyle(
                                              fontWeight: FontWeight.bold,
